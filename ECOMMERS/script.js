function HeadComponent(){
    ...
    header.setAttribute("class","bg-dark white p-2 d-flex justify-content-around align-item-center");
    ...
    header.appendChild(logoDiv); // Header is a parent of these.
    header.appendChild(searchDiv);
    header.appendChild(optionDiv);
    mainDiv.appendChild(header);
   
    // Creating logo
    logoDiv.setAttribute("style","heigth:60px; width:10%; margin-left:10px");
    logoDiv.setAttribute("class","d-flex justify-content-center align-item-center");
    let logoText = document.createElement("p");
    logoText.innerHTML = "<strong class='text-danger'>E-</strong><span class='text-white'>shop</span>"
    logoText.setAttribute("style",'font-size:30px');
    logoDiv.appendChild(logoText);
    header.appendChild(logoDiv);
   
   //seach div
   searchDiv.setAttribute("style","width: 70%");
   searchDiv.setAttribute("class","d-flex justify-content-center align-item-center");
   let searchInput = document.createElement("input");
   searchInput.setAttribute("placeholder","search product by name");
   searchInput.setAttribute("style","width:80%; height:50px");
   searchDiv.appendChild(searchInput);
   header.appendChild(searchDiv);
   
   // provide option
   optionDiv.setAttribute("style","width:17%; ");
   optionDiv.setAttribute("class"," text-danger d-flex justify-content-around align-item-center");
   
   let signInOption = document.createElement("span");
   signInOption.innerText = "signIn";
   ...
   function data(){
       let product =  [
           ...
           // Now we need to convert j-son object to j-son String
   
           localStorage.setItem("productList",JSON.stringify(product));
         
   }
   
   function  cardContenerComponent(){
       let mainDiv = document.getElementById("main"); 
